...
date: "2020-02-03T11:09:00+00:00"
...
1. Frontend development can be _really_ tedious. I now understand why most bloggers and online content creators tend to use batteries-included CMS platforms like WordPress. It takes a lot of time and effort to personalize fonts, customize CSS, pick colours and general styles, and format the various widgets on even a simple static site. And after finally deciding on _how_ the page will look, we still need to create some actual content! As a software engineer, I enjoy tinkering and learning how things work under the hood, but it makes perfect sense that most people will just say "f\*\*k this" and install WordPress.
