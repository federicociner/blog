---
title: "Algorithms in Python: Insertion-Sort"
date: "2020-02-09T10:42:00+00:00"
description: "A simple implementation of insertion-sort in Python."
tags: ["algorithms", "insertion sort", "interviews", "programming", "python"]
---

## Overview

As a continuation from yesterday's [post](../../08/data_structures_arrays) about the various array-based sequence classes in Python, we will now look at implementing the insertion-sort algorithm, which is a simple sorting algorithm that can be used to sort array-based sequences.
