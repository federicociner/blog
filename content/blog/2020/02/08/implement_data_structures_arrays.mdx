---
title: "Implementing Data Structures in Python: Array-based Sequences"
date: "2020-02-08"
description: "A discussion of Python's sequence types and how to implement a dynamic array."
tags:
  [
    "algorithms",
    "arrays",
...
- [Arrays: A Primer](#arrays-a-primer)
- [Sequence Classes in Python](#sequence-classes-in-python)
  - [Strings](#strings)
  - [Tuples](#tuples)
- [Lists](#lists)
- [Dynamic Arrays: A Basic Implementation](#dynamic-arrays-a-basic-implementation)
- [Efficiency of Python's Sequence Types](#efficiency-of-pythons-sequence-types)
  - [Non-mutating Behaviours](#non-mutating-behaviours)
  - [Mutating Behaviours](#mutating-behaviours)
...
- [Constructing New Lists](#constructing-new-lists)
...
Here's an example where we initialize an instance of `DynamicArray` and add three elements.
